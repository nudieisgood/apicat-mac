...
class PropertyBase {
  constructor(definition) {
    ...
    let src = definition && definition.info || definition
    let meta = _(src).pickBy(PropertyBase.propertyIsMeta).mapKeys(PropertyBase.propertyUnprefixMeta).value();
...
Object.assign(PropertyBase.prototype, {
  /**
