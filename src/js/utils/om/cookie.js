// import Util from '@/js/utils/om/util.js'
const Util = require('@/js/utils/om/util.js');
const PropertyBase = require('@/js/utils/om/propertyBase.js');
const PropertyList = require('@/js/utils/om/propertyList.js');

let _PropertyBase = PropertyBase
let _PropertyList = PropertyList
// let _PropertyBase = PropertyBase.PropertyBase
...
let E = ''
let EQ = '='
let PAIR_SPLIT_REGEX = /; */
let COOKIES_SEPARATOR = '; '
...
_.assign(Cookie, /** @lends Cookie */ {
   ...
   * @type {String}
   */
  _apicat_propertyName: 'Cookie',

  // define behaviour of this object when put in list
  _apicat_propertyIndexKey: 'name',
  _apicat_propertyIndexCaseInsensitive: true,
  _apicat_propertyAllowsMultipleValues: true,
  ...
  isCookie: function (obj) {
      return Boolean(obj) && ((obj instanceof Cookie) ||
          _.inSuperChain(obj.constructor, '_apicat_propertyName', Cookie._apicat_propertyName));
  },
  ...
  unparse: function (cookies) {
      if (!_.isArray(cookies) && !_PropertyList.isPropertyList(cookies)) {
          return E;
      }
